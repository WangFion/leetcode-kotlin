...
/**
 * leetcode -> com.wf.leetcode.daily_03 -> `30、机器人能否返回原点`
 *
 * @Author: wf-pc
 * @Date: 2020-08-28 09:13
 * ------------------------
 * 657题：https://leetcode-cn.com/problems/robot-return-to-origin/
...
fun main() {
    val move1 = "UD"
    println(judgeCircle(move1))

    val move2 = "LL"
    println(judgeCircle(move2))

    val move3 = "RRDD"
    println(judgeCircle(move3))
}
